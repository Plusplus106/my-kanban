...
> - 📋 任務卡片必要欄位規範
> - 📋 暫存檔案管理
> - ⭐ **Lint 檢查必須通過** (所有程式碼必須通過 ESLint/Pylance 檢查)
...
1. **任務必須放在日期-spec 編號-feature 名稱資料夾中**
   - 例如: `3-Progressing/2025-12-01-[spec-Xm1q2]-payment-integration/2025-12-01-[spec-Xm1q2]-2-high-[plan-Az4a2]-feature-stripe-integration.md`
2. **從 2-Plans 移動任務時，保持相同的日期和 spec 資料夾結構**
   - `2-Plans/2025-12-01-[spec-Xm1q2]-payment-integration/xxx.md` → `3-Progressing/2025-12-01-[spec-Xm1q2]-payment-integration/xxx.md`
3. **⚠️ 資料夾命名格式:** `[YYYY-MM-DD]-[spec-xxxxx]-[feature-name]`
   - ❌ 錯誤: `3-Progressing/2025-12-01-[spec-Xm1q2]/`（缺少 feature-name）
   - ❌ 錯誤: `3-Progressing/2025-12-01-[plan-Xm1q2]-payment-integration/`（不可使用 `[plan-xxxxx]` 作為父資料夾識別）
   - ✅ 正確: `3-Progressing/2025-12-01-[spec-Xm1q2]-payment-integration/`
...
- **移動時保持相同的檔案名稱與父層資料夾結構**
  ```
  2-Plans/2025-12-31-[no-spec]-bugfix-login/2025-12-31-[no-spec]-1-urgent-[plan-Bz8k3]-bug-fix-login-timeout.md
  ↓
  3-Progressing/2025-12-31-[no-spec]-bugfix-login/2025-12-31-[no-spec]-1-urgent-[plan-Bz8k3]-bug-fix-login-timeout.md
  ```
...
**實際使用的 AI 工具:** [AI 名稱] ← 新增此欄位，記錄實際處理的 AI
**實際使用的 AI 工具:** [AI 名稱] ← 新增此欄位，記錄實際處理的 AI
